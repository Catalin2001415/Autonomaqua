...
(() => {
    ...
    i.n = e => {
        ...
        class Fe {
            ...
            check() {
                document.querySelectorAll('[data-tabs="'.concat(this.selector, '"]')).length > 1 ? console.error("Количество элементов с одинаковым data-tabs больше одного!") : this.tabsBtns.length === this.tabsPanels.length || console.error("Количество кнопок и элементов табов не совпадает!")
            }
            ...
            init() {
                ...
                this.tabsBtns[0].classList.add("tabs__nav-btn--active"), this.tabsBtns[0].removeAttribute("tabindex"), this.tabsBtns[0].setAttribute("aria-selected", "true"), this.tabsPanels[0].classList.add("tabs__panel--active"), null === (e = this.tabsDropdownBtn) || void 0 === e || e.addEventListener("click", (e => {
                    var t;
                    t = "Показать фильтры" === e.currentTarget.innerHTML ? "Скрыть фильтры" : "Показать фильтры", e.currentTarget.innerHTML = t, this.tabsDropdown.classList.toggle("active")
                }))
            }
        ...
        new class {
            ...
            init() {
                this.оbjects = [], this.daClassname = "_dynamic_adapt_", this.nodes = [...document.querySelectorAll("[data-da]")], this.nodes.forEach((e => {
                    ...
                    i.element = e, i.parent = e.parentNode, i.destination = e.closest("".concat(t[0].trim())), i.breakpoint = t[1] ? t[1].trim() : "767", i.place = t[2] ? t[2].trim() : "last", i.index = this.indexInParent(i.parent, i.element), this.оbjects.push(i)
                })), this.arraySort(this.оbjects), this.mediaQueries = this.оbjects.map((e => {
                    let {breakpoint: t} = e;
                    return "(".concat(this.type, "-width: ").concat(t, "px),").concat(t)
                })).filter(((e, t, i) => i.indexOf(e) === t)), this.mediaQueries.forEach((e => {
                    const t = e.split(","), i = window.matchMedia(t[0]), s = t[1], n = this.оbjects.filter((e => {
                        let {breakpoint: t} = e;
                        return t === s
                    }));
