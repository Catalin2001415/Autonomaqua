...
?>
    <section class="licenses">
        <div class="container licenses__container">
            ...
            <h1 class="g-title g-title--xl licenses__title">Лицензии</h1>
            <?$APPLICATION->IncludeComponent("bitrix:news", "licenses", Array(
                "ADD_ELEMENT_CHAIN" => "Y",	// Включать название элемента в цепочку навигации
                    ...
                    "IBLOCK_TYPE" => "licenses",	// Тип инфоблока
                    ...
                    "SEF_FOLDER" => "/licenses/",	// Каталог ЧПУ (относительно корня сайта)
    ...
    <?$APPLICATION->IncludeFile("/include/blocks/seo.php",false,['SHOW_BORDER' => false]);?>
